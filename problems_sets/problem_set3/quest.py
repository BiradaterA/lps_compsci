...
if (choice == 'right') or (choice == 'Right'):
	...
	if strength >= 7:
                ...
                print("Sorry, your strength, your health, nor your luck could save you from this situation. You were eaten by the pack of wolves and the bats drank your blood. You lost.")
